...
// Image paths for deployment - using dynamic imports for better compatibility
const IMAGES = {
  swanClothing: new URL('/img/swan-clothing.webp', import.meta.url).href,
  finix: new URL('/img/Finix.webp', import.meta.url).href,
  maledaCoffee: new URL('/img/Maleda-Coffee.webp', import.meta.url).href,
  andegna: new URL('/img/Andegna.webp', import.meta.url).href,
  yatConstruction: new URL('/img/YAT-Construction-PLC.webp', import.meta.url).href,
  alta: new URL('/img/Alta.webp', import.meta.url).href,
  medavail: new URL('/img/Medavail.webp', import.meta.url).href,
  andegnaTshirt: new URL('/img/Andegna-Tshirt.webp', import.meta.url).href,
  niqatMenu: new URL('/img/Niqat-Menu.webp', import.meta.url).href,
  rollupBanners: new URL('/img/Rollup-Banners.webp', import.meta.url).href,
  bereketFikre: new URL('/img/Bereket-Fikre.webp', import.meta.url).href,
  gedy: new URL('/img/Gedy.webp', import.meta.url).href,
  dag: new URL('/img/Dag.webp', import.meta.url).href,
  abenezer: new URL('/img/Abenezer.webp', import.meta.url).href,
  kass: new URL('/img/Kass.webp', import.meta.url).href,
  miko: new URL('/img/Miko.webp', import.meta.url).href,
  hayle: new URL('/img/Hayle.webp', import.meta.url).href,
  andegnaLogo: new URL('/img/Andegna-Logo-Outline.webp', import.meta.url).href,
  niqat: new URL('/img/Niqat.webp', import.meta.url).href,
  primeAll: new URL('/img/Prime-All.webp', import.meta.url).href,
  medavailLogo: new URL('/img/Medavail-logo.webp', import.meta.url).href,
  gedylaw: new URL('/img/Gedylaw.webp', import.meta.url).href,
  pdcLogo: new URL('/img/PDC-Logo.webp', import.meta.url).href,
};
